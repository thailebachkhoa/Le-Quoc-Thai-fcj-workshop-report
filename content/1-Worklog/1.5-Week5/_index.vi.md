...
| **4** | - Đưa code từ GitHub lên EC2 (git clone/git pull), cấu hình `.env`, kiểm thử toàn bộ luồng đã chạy được trên localhost <br> - Tự động hóa việc tắt EC2 - RDS qua Lambda và EvenBride: khắc phục hạn chế ec2 và RDS tính tiền 24/7 | `10/07/2026` | 2 ngày |
